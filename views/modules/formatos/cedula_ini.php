...
//216,279
	...
	$pdf->MultiCell(96,5,utf8_decode($domicilio),0,'L',false);
	...
	$pdf->SetXY(100,153);
	$pdf->Cell(10,5,utf8_decode('SI'),1,0,'L',true);
	$pdf->SetXY(115,153);
	...
	$pdf->SetXY(20,178);
	$pdf->Cell(25,5,utf8_decode('¿SEDIO UNA INCAPACIDAD PARCIAL PERMANENTE?'),0,0,'L',true);
	$riesg_inc = $methods->comp_SIorNO($cedula['incapacidad']);
	$pdf->SetXY(100,178);
	$pdf->Cell(10,5,utf8_decode('SI'),1,0,'L',true);
	$pdf->SetXY(115,178);
	$pdf->Cell(15,5,utf8_decode($riesg_inc['afirm']),1,0,'L',true);
	...
	$pdf->SetXY(58,191);
	$pdf->Cell(110,4,utf8_decode($name),1,0,'L',true);
